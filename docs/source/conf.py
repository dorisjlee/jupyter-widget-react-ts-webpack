...
# -*- coding: utf-8 -*-
#
# displayWidget documentation build configuration file
#
...
project = 'displayWidget'
copyright = '2019, Doris Lee'
author = 'Doris Lee'
...
_version_py = os.path.join(repo, 'displayWidget', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'displayWidgetdoc'
...
latex_documents = [
    (master_doc, 'displayWidget.tex', 'displayWidget Documentation',
     'Doris Lee', 'manual'),
]
